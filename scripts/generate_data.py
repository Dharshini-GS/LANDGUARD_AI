...
# Set up geographic master for India (28 States + 8 UTs)
GEOGRAPHIC_MASTER = {
    # 28 States
...
def generate_users(seed=42):
    ...
    # 2. STATE_OFFICER users (2 per State/UT = 72)
    state_officers_map = {}
    so_cnt = 1
    ...
    # 3. DISTRICT_OFFICER users (1 per district across ALL districts)
    ...
    # 4. PROJECT_MANAGER users (150 PMs)
    project_managers = []
    ...
    # Ensure every state has at least 1 PM
...
def generate_dataset(target_projects=1200, seed=42):
    ...
    # STEP 1: Assign at least 1 project to every district
    project_geo_locations = list(all_districts_list)

    # STEP 2: Weighted random distribution for remaining projects
    ...
    for p_idx in range(1, actual_total_projects + 1):
        ...
        # Check for DEMO HIGH-RISK PROJECT (Project LG-000042)
        ...
        # --- CHILD DATA GENERATION WITH RISK CORRELATION ---
        if is_demo_high_risk:
            risk_tier = "CRITICAL"
        else:
        ...
        # 2. Lifecycle Timeline (EXACTLY 11 STAGES)
        ...
        # 4. Legal Disputes (0-10 per project)
        if is_demo_high_risk:
            n_legal = 18
        ...
        # 6. Documentation (5-15 per project)
        ...
        # 7. Rehabilitation & R&R (1-3 records per project)
        ...
        # 8. Stakeholders (3-8 per project)
        ...
        # 9. Administrative Performance (2-5 per project)
        ...
        # 10. Geospatial (EXACTLY 1 per project)
        ...
        # 11. Project Outcomes (EXACTLY 1 per project - ML TARGET DATA ONLY)
        ...
        # 12. Risk History (5-20 per project)
